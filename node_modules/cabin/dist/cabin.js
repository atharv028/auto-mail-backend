...
},{"../package.json":5,"@ladjs/format-util":1,"@strikeentco/get":2,"@strikeentco/set":3,"_process":26,"boolean":7,"console-polyfill":10,"format-specifiers":11,"iserror":17,"maybe-combine-errors":20,"merge-options":21,"os":22,"p-map-series":23,"parse-app-info":9,"parse-err":24,"pick-deep":25,"unset-value":27}],5:[function(require,module,exports){
module.exports={
  "name": "axe",
...
},{"get-value":12,"has-values":15}],15:[function(require,module,exports){
/*!
...
},{"kind-of":19}],16:[function(require,module,exports){
'use strict';
...
},{"iserror":17}],25:[function(require,module,exports){
'use strict';
...
},{"has-value":14,"isobject":18}],28:[function(require,module,exports){
module.exports={
  "name": "cabin",
  ...
  constructor(config) {
    ...
    for (const level of Object.keys(this.config.logger).filter(key => isFunction(this.config.logger[key]))) {
      this[level] = function () {
        ...
        _this.config.logger[level](...Array.prototype.slice.call(args));
      };
    }
...
},{"../package.json":28,"./message":9,"./middleware":9,"./utils":30,"axe":4,"iserror":17,"merge-options":21,"parse-err":24}],30:[function(require,module,exports){
function isNull(value) {
  return value === null;
}
function isUndefined(value) {
